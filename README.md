...
The thinned row skeletons are grouped into individual row instances using clustering based on spatial proximity and orientation. Each cluster is fitted with a line (Probabilistic Hough transform) to represent the row’s central axis.
